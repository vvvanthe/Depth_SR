...
flags.DEFINE_integer("layers", 7, "Number of layers of feature xxtraction CNNs")
flags.DEFINE_integer("filters", 32, "Number of filters of first feature-extraction CNNs")
flags.DEFINE_integer("min_filters", 32, "Number of filters of last feature-extraction CNNs")
flags.DEFINE_float("filters_decay_gamma", 1.5,
                   "Number of CNN filters are decayed from [filters] to [min_filters] by this gamma")
flags.DEFINE_boolean("use_nin", False, "Use Network In Network")
...
flags.DEFINE_integer("reconstruct_layers", 0, "Number of Reconstruct CNN Layers. (can be 0.)")
flags.DEFINE_integer("reconstruct_filters", 0, "Number of Reconstruct CNN Filters")
...
flags.DEFINE_integer("pixel_shuffler_filters", 1,
...
flags.DEFINE_integer("batch_image_size", 96, "Image size for mini-batch")
flags.DEFINE_integer("stride_size", 0, "Stride size for mini-batch. If it is 0, use half of batch_image_size")
flags.DEFINE_integer("training_images", 80000, "Number of training on each epoch")
...
flags.DEFINE_float("initial_lr", 0.002, "Initial learning rate") #0.002
...
# Dataset or Others
flags.DEFINE_string("dataset", "hevc_set6choi", "Training dataset dir of output. [hevc_set6choi]")
flags.DEFINE_string("dataset_in", "hevc_set6choi_in", "Training dataset dir of input. [hevc_set6choi_in]")
